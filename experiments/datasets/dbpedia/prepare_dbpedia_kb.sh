...
# Results:
#   - STORAGE_DATA/dbpedia/kb/dbpedia20200201.entity_dict.json
python prepare_dbpedia_kb.py \
    --input_file ${DBPEDIA}/long-abstracts_lang_en.ttl \
    --output_file ${STORAGE_DATA}/dbpedia/kb/dbpedia20200201.entity_dict.json
