...
# Results:
#   - STORAGE_DATA/linked_docred/meta/rel2id.json
#   - STORAGE_DATA/linked_docred/meta/rel_info.json
#   - STORAGE_DATA/linked_docred/meta/ner2id.json
mkdir -p ${STORAGE_DATA}/linked_docred/meta
cp ${DOCRED}/DocRED_baseline_metadata/rel2id.json ${STORAGE_DATA}/linked_docred/meta/
cp ${LINKED_DOCRED}/rel_info.json ${STORAGE_DATA}/linked_docred/meta/
cp ${DOCRED}/DocRED_baseline_metadata/ner2id.json ${STORAGE_DATA}/linked_docred/meta/
