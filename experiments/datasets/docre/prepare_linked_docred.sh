...
# Results:
#   - STORAGE_DATA/docre/linked_docred/meta/rel2id.json
#   - STORAGE_DATA/docre/linked_docred/meta/rel_info.json
#   - STORAGE_DATA/docre/linked_docred/meta/ner2id.json
mkdir -p ${STORAGE_DATA}/docre/linked_docred/meta
