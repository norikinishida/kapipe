...
# Results:
#   - STORAGE_DATA/mdcr/corpus/articles.jsonl
#   - STORAGE_DATA/mdcr/qa/questions.json
#   - STORAGE_DATA/mdcr/qa/questions.gold_contexts.json
python prepare_mdcr_qa_and_corpus.py \
    --input_repository_dir "${MDCR}/mdcr" \
    --output_articles_file "${STORAGE_DATA}/mdcr/corpus/articles.jsonl" \
    --output_questions_file "${STORAGE_DATA}/mdcr/qa/questions.json" \
    --output_gold_contexts_file "${STORAGE_DATA}/mdcr/qa/questions.gold_contexts.json"
