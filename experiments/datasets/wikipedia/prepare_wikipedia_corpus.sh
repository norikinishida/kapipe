...
python -m wikiextractor.WikiExtractor ${WIKIPEDIA}/${WIKIPEDIA_DUMP_FILENAME} \
    -o ${STORAGE_DATA}/wikipedia/corpus/${WIKIPEDIA_DUMP_FILENAME}.extracted \
    --json \
    --processes 4 \
    -b 1G
...
# Results:
#   - STORAGE_DATA/wikipedia/corpus/WIKIPEDIA_DUMP_FILENAME.extracted.processed.jsonl
python prepare_wikipedia_corpus.py \
    --input_dir ${STORAGE_DATA}/wikipedia/corpus/${WIKIPEDIA_DUMP_FILENAME}.extracted \
    --output_file ${STORAGE_DATA}/wikipedia/corpus/${WIKIPEDIA_DUMP_FILENAME}.extracted.processed.jsonl
