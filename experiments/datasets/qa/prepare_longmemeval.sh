...
# Results:
#   - STORAGE_DATA/qa/longmemeval/{small,medium}.json
#   - STORAGE_DATA/qa/longmemeval/{small,medium}.sessions.json
python prepare_longmemeval.py \
    --input_small_file "${LONGMEMEVAL}/longmemeval_s_cleaned.json" \
    --input_medium_file "${LONGMEMEVAL}/longmemeval_m_cleaned.json" \
    --output_dir "${STORAGE_DATA}/qa/longmemeval"
