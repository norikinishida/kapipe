...
# Results:
#   - STORAGE_DATA/articles/confrag/articles.jsonl
#   - STORAGE_DATA/qa/confrag/train.json
#   - STORAGE_DATA/qa/confrag/train.gold_contexts.json
python prepare_confrag.py \
    --input_file "${CONFRAG}/${CONFRAG_FILENAME}" \
    --output_articles_file "${STORAGE_DATA}/articles/confrag/articles.jsonl" \
    --output_dir "${STORAGE_DATA}/qa/confrag"
