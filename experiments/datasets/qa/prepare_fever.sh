...
# Results:
#   - STORAGE_DATA/articles/fever/articles.jsonl
#   - STORAGE_DATA/qa/fever/{train,dev}.json
#   - STORAGE_DATA/qa/fever/{train,dev}.gold_contexts_sets.json
python prepare_fever.py \
    ...
    --output_articles_file "${STORAGE_DATA}/articles/fever/articles.jsonl" \
    --output_dir "${STORAGE_DATA}/qa/fever"
