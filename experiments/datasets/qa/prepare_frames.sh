...
OUTPUT_ARTICLES_FILE="${STORAGE_DATA}/articles/frames/enwiki-${WIKIPEDIA_DATE}.articles.jsonl"
OUTPUT_QA_DIR="${STORAGE_DATA}/qa/frames"
...
# Results:
#   - STORAGE_DATA/articles/frames/enwiki-WIKIPEDIA_DATE.articles.jsonl
#   - STORAGE_DATA/qa/frames/test.json
#   - STORAGE_DATA/qa/frames/test.gold_contexts.json
