...
This directory contains example experiments for context formatting (`kapipe.context_formatting`).
...
cd experiments/context_formatting
...
```bash
experiments/context_formatting/data/examples/misc/questions.graph_contexts.json
```
...
```bash
experiments/context_formatting/config/graph_verbalizer.conf
```
...
```bash
bash ./run_context_formatting.sh
```
