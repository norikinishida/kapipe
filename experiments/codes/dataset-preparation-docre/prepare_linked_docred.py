...
def get_entities(data, local_shift_map, local_to_global_map, mentions):
    ...
    for entity_i, entity in enumerate(data["entities"]):
        ...
        if not entity_id in entities:
            ...
            raise Exception(f"Multiple entities with the same ID are found!: entity id: {entity_id}")
...
def get_relations(data):
    ...
    relations = remove_duplicated_relations(relations=relations)        
    return relations
