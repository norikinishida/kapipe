...
bash ./run_prostruct_rag_pipeline.sh --actiontype proposition_relation_extraction --batch_mode submit
bash ./run_prostruct_rag_pipeline.sh --actiontype proposition_relation_extraction --batch_mode fetch
bash ./run_prostruct_rag_pipeline.sh --actiontype proposition_relation_refinement --batch_mode submit
bash ./run_prostruct_rag_pipeline.sh --actiontype proposition_relation_refinement --batch_mode fetch
bash ./run_prostruct_rag_pipeline.sh --actiontype passage_graph_construction
bash ./run_prostruct_rag_pipeline.sh --actiontype passage_retrieval_indexing
bash ./run_prostruct_rag_pipeline.sh --actiontype inference --batch_mode submit
bash ./run_prostruct_rag_pipeline.sh --actiontype inference --batch_mode fetch
```
