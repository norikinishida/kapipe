...
This directory contains example experiments for proposition relation extraction (`kapipe.proposition_relation_extraction`).
...
cd experiments/proposition_relation_extraction
...
```bash
bash ./run_proposition_relation_extraction.sh
```
...
```bash
bash ./run_proposition_relation_extraction.sh --batch_mode submit
bash ./run_proposition_relation_extraction.sh --batch_mode fetch
```
